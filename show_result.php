...
//                                                    
                                    ...
                                    <tr>
                                      <td rowspan="1" class="center aligned"><h3>Host Protein</h3></td>
                                      <td><a href="https://opendata.ncats.nih.gov/covid19/assay?aid=21" target='_self' class="hover_color">Sigma1 Receptor (sigma1R)</a></td>

                                         <!-- <?php
                                                 if ($result_ar['sigma1R_prediction'] == "ACTIVE"){
                                                     echo "<td><b><span class='badge bg-success' ' data-position='left center'>", $result_ar['sigma1R_prediction'], "</span></b></td>";
                                                     if ($result_ar['sigma1R_probability']==1){
                                                        echo "<td><b><span class='badge bg-success' data-tooltip='Experimentally Validated' data-position='left center'>", $result_ar['sigma1R_probability'], "</span></b></td>";
                                                    }

                                                    else{
                                                        hoverTable($result_ar['sigma1R_prediction'],$result_ar['sigma1RDes_model'],$result_ar['sigma1RDes_prediction'],$result_ar['sigma1RDes_probability'],$result_ar['sigma1RFP_model'],$result_ar['sigma1RFP_prediction'],$result_ar['sigma1RFP_probability'],$result_ar['sigma1RTopo_model'],$result_ar['sigma1RTopo_prediction'],$result_ar['sigma1RTopo_probability'],$result_ar['sigma1R_probability']);
                                                    }

                                                 }
                                                 else{
                                                    echo "<td><b><span class='badge bg-danger' ' data-position='left center'>", $result_ar['sigma1R_prediction'], "</span></b></td>";
                                                    
                                                    if ($result_ar['sigma1R_probability']==1){
                                                        echo "<td><b><span class='badge bg-danger' data-tooltip='Experimentally Validated' data-position='left center'>", $result_ar['sigma1R_probability'], "</span></b></td>";
                                                    }
                                                    else{
                                                        hoverTable($result_ar['sigma1R_prediction'],$result_ar['sigma1RDes_model'],$result_ar['sigma1RDes_prediction'],$result_ar['sigma1RDes_probability'],$result_ar['sigma1RFP_model'],$result_ar['sigma1RFP_prediction'],$result_ar['sigma1RFP_probability'],$result_ar['sigma1RTopo_model'],$result_ar['sigma1RTopo_prediction'],$result_ar['sigma1RTopo_probability'],$result_ar['sigma1R_probability']);
                                                    }
